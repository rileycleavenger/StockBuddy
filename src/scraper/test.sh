...
gcloud run deploy sb-service --image us-central1-docker.pkg.dev/gator-path-tracker/sb-repo/test-sb --region us-central1 --platform managed --memory=32Gi --cpu 8 --timeout=60m